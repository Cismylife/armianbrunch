...
# Forked program of Armian Installer
# Distributed under the GPL version 3 license
#

"""
Post installation script for Armian OS 7 LTS
"""
...
_CONF_FILE = "https://raw.github.com/thegreatstudio/armianbrunch/master/configure.cfg"
...
def syntax():
    ...
    """
    print "Armian OS 7  post installation script version %s" % _VERSION
    print ""
    print "Syntax: armianos-7-postinstall.py [-c cfgfile] [-h] [-v]"
    ...
    print "Examples:"
    print ""
    print " # armianos-7-postinstall.py"
    print " > Run the script with the default configuration file"
    print "   %s" % _CONF_FILE
    print ""
    print " # armianos-7-postinstall.py -c ./myconf.cfg"
    print " > Run the script with the ./myconf.cfg file"
    print ""
    print " # armianos-7-postinstall.py -c http://mysite.com/myconf.cfg"
